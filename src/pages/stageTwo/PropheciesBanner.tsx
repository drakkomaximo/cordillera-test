...
const PropheciesBanner = ({ active = true }: { active?: boolean }) => {
  ...
  return (
    <section className="relative w-full max-w-[1440px] h-[900px] mx-auto flex flex-col bg-black overflow-hidden rounded-lg mt-12 px-0 py-12">
      <div className="relative z-20 w-full flex justify-center mb-8">
        <OutlinedTitle className="text-left md:text-center max-w-3xl mx-auto text-[52px] md:text-[56px] lg:text-[85px] leading-tight">
          PROFECÍAS CORDILLERA
        </OutlinedTitle>
      </div>
      <div className="absolute inset-0 left-[60px] top-[150px] z-0 flex items-center">
        <Image
      ...
      <div className="relative z-10 flex flex-col items-start justify-center ml-auto w-full md:w-[50%] px-4 md:px-16 pt-48">
