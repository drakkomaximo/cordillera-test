                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <label htmlFor="terms" className="flex items-center gap-2 cursor-pointer select-none">
                        ...
                        />
                        <span
                          className={`w-4 h-4 flex items-center justify-center border border-mainlight rounded transition-colors duration-200 ${termsChecked ? 'bg-mainlight' : 'bg-transparent'}`}
                        ...
                        <span className="text-form-disclaimer-mobile text-mainlight font-normal font-economica">
                          Al hacer clic en Registrarte, confirmas que estás de acuerdo con nuestros Términos y Condiciones
                        </span>
                      </label>
                    </div>
